...
const checks = [
  ...
  },
  {
    ...
    area: 'recognitionClaims',
    pass: includesAll(indexHtml, [
      'Flor no detectada claramente',
      'Veo mucha hoja o fondo',
      'Predomina hoja/fondo, no flor',
      'Centra una flor abierta para identificarla',
    ]),
  ...
  },
  {
    ...
    pass: includesAll(indexHtml, [
      'luz natural',
      'fondo limpio',
      'solo la flor centrada',
      'Acércate a una flor abierta',
      'Flor completa',
      'completa y enfocada',
      'evita varias flores mezcladas',
    ]),
